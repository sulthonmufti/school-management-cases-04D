...
menu:
  ...
  cout << "== 18) Rincian dana masuk dan keluar ==" << endl;
  cout << "== 19) Login kembali                 ==" << endl;
  cout << "== 20) Login sebagai user            ==" << endl;
  cout << "== 21) Keluar program                ==" << endl;
  cout << "=======================================" << endl;
  cout << "pilihan menu : ";
  cin >> pmenu;
  cout << endl;
...
//Deklarasi menu_utamaPerencanaan pada class manajemen
//untuk membuat menu pilihan fitur perencanaan
